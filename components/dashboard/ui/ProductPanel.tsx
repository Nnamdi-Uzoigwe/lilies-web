...
export default function ProductPanel() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 bg-white z-60 overflow-y-auto p-6 lg:hidden transition-transform duration-300 ease-in-out ${
      ...
      <div
        className={`hidden lg:flex flex-col fixed top-0 right-0 h-full w-1/2 bg-white z-60 shadow-2xl border-l border-gray-200 px-10 py-8 overflow-y-auto transition-transform duration-300 ease-in-out ${
      ...
      <div className="flex justify-evenly w-full items-center gap-4 mt-6">
        <div className="flex items-center gap-4 rounded-md px-4 py-2">
          <button
            ...
            className="text-lg font-bold bg-[#F3C294] rounded-md px-4 py-4 lg:py-6 cursor-pointer"
          >
            <FaMinus />
          </button>
        ...
        <button
          ...
          className="flex-1 bg-[#00302E] text-white py-4 lg:py-5 rounded-md font-semibold"
        >
          Add to cart
        </button>
      </div>

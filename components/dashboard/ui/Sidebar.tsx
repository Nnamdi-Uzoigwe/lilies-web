...
//         {/* Logo Section */}
//         <div
//           className={` mt-10 transition-all duration-300 ease-in-out px-6 py-4`}
//         >
//           <div className={`flex justify-center items-start flex-row`}>
//             {/* Logo + Text */}
//             <div
//               className={`flex gap-2 transition-all duration-300 ease-in-out items-center`}
//             >
//               {/* Logo */}
  ...
  const menuItems: MenuItem[] = [
    {
      ...
      icon: <TbLayoutDashboard size={22} />,
      href: "/dashboard",
      exact: true, // only active on exactly /dashboard
    },
    {
      id: "profile",
      label: "Your Profile",
